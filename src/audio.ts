...
export class AudioPerformer{
 ...
 private ensure(){if(this.ctx)return;const c=this.ctx=new AudioContext();this.drums=DrumMachine(c,{instrument:"TR-808",volume:105}) as unknown as SmplrInstrument;this.bass=Soundfont(c,{instrument:"electric_bass_finger",kit:"FluidR3_GM",volume:95}) as unknown as SmplrInstrument;this.keys=ElectricPiano(c,{instrument:"WurlitzerEP200",volume:78}) as unknown as SmplrInstrument;this.lead=Soundfont(c,{instrument:"muted_guitar",kit:"FluidR3_GM",volume:88}) as unknown as SmplrInstrument;this.loading=Promise.all([this.drums.ready,this.bass.ready,this.keys.ready,this.lead.ready]).then(()=>undefined)}
}